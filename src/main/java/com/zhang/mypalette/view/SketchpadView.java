package com.zhang.mypalette.view;
...
import com.zhang.mypalette.activity.SketchpadMainActivity;
import com.zhang.mypalette.contral.BitmapCtl;
import com.zhang.mypalette.contral.BitmapUtil;
import com.zhang.mypalette.contral.Circlectl;
import com.zhang.mypalette.contral.EraserCtl;
import com.zhang.mypalette.contral.LineCtl;
import com.zhang.mypalette.contral.OvaluCtl;
import com.zhang.mypalette.contral.PenuCtl;
import com.zhang.mypalette.contral.PlygonCtl;
import com.zhang.mypalette.contral.RectuCtl;
import com.zhang.mypalette.contral.Spraygun;
import com.zhang.mypalette.data.CommonDef;
import com.zhang.mypalette.interfaces.ISketchpadDraw;
import com.zhang.mypalette.interfaces.IUndoRedoCommand;
...
public class SketchpadView extends View implements IUndoRedoCommand {
	...
	protected void onDraw(Canvas canvas) {
		...
		if (null != m_foreBitmap){
			...
			Log.d(TAG, "onDraw:m_foreBitmap "+m_foreBitmap);
		}
		if (null != m_curTool){
